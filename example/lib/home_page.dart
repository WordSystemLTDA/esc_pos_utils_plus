...
class _HomePageState extends State<HomePage> {
  ...
  late TextEditingController printNameCtrl = TextEditingController(text: printerName);
  late TextEditingController printAddressCtrl = TextEditingController(text: printerAddress);
          ...
          children: [
            ...
            if (mode == PrintMode.NETWORK) ...[
              TextFormField(
                ...
                decoration: const InputDecoration(label: Text("Printer Address")),
              )
            ],
            Expanded(
              child: ListView(
                children: [
                  ...
                  ListTile(onTap: printColumns, title: const Text("print columns")),
  ...
  printImage() async {
    ...
    bytes += generator.imageRaster(img.copyResize(image, width: (297 * 2), height: (image.height * ratio).toInt()));
